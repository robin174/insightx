								...
								<div class="grid-x grid-padding-x">
									...
									<div class="small-12 medium-6 large-6 cell medium-text-right">
										<div class="foot--contact">
											...
											<a href="<?php echo get_page_link( get_page_by_path( 'privacy-policy-ix' ) ); ?>" title="Privacy Policy">Privacy Policy</a> | <a href="<?php echo get_page_link( get_page_by_path( 'cookie-policy-ix' ) ); ?>" title="Cookie Policy">Cookie Policy</a></p>
										</div>
									</div>
									<div class="small-12 large-12 cell">
