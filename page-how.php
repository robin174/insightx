					...
					<section class="small-12 medium-12 large-12 cell">
						...
						<div class="grid-container grid-x grid-padding-x">
	               			<div class="small-12 medium-12 large-12 cell">
								<h1 class="with--logo"><img class="in--title" src="<?php echo get_template_directory_uri(); ?>/images/insightx-logo-white-n.svg" title="Logo - Insight.X ">Reputational Risk Reports</h1>
							</div>
						</div>			
