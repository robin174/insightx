<div style="position: relative;">
	...
	<!-- DONE as per individual element -->
	<section class="boxOne">
		<div class="boxOne_inner" style="background-position: center;background-image: url('<?php echo get_template_directory_uri(); ?>/images/insightx-circles-col-v1.png');background-repeat: no-repeat;">
		</div>
	</section>

	<!-- 	Reputations are hard won 
			but easily lost.

			<section class="boxTwo">
				<div class="blockIntroduction">
					<span class="largeText">Reputations are hard won...<br></span>
					<span class="largeText">but easily lost</span>
				</div>
			</section>
	-->
	...
	<section class="boxThree">
		<div class="boxThree_logo logo-animate" style="width:400px;">
	...
	<section class="boxFour">
		<div class="innerBoxFoil" style="background-position: center;background-image: url('<?php echo get_template_directory_uri(); ?>/images/insightx-red-foil.jpg');"></div>
	</section>
	
	<!-- DONE as per individual element -->
	<section class="boxFive">
		<figure class="dispLogo">
