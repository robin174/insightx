<div style="position: relative;">
	...
	<section class="boxTwo">
		<div class="blockIntroduction">
			<span class="largeText first">Reputations are hard won...<br></span>
			<span class="largeText second">but easily lost</span>
		</div>
	</section>
	...
	<section class="boxThree">
		<div class="innerBoxFoil" style="background-image: url('<?php echo get_template_directory_uri(); ?>/images/insightx-red-foil.jpg');background-position: center;background-repeat: no-repeat;">
		</div>
	</section>
	*/?>
	...
	<!-- Complete: Backup and working, mo background -->
	<?php /*
	<section class="boxFour">
		<div class="boxFour_logo logo-animate" style="width:400px;">
			<svg version="1.1" id="Logo_-_White" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
