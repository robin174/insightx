<?php while(has_sub_field("add_page_content")): ?>
    ...
    <?php if(get_row_layout() == 'block_video'): // layout: Video ?>
        <?php if(get_sub_field('unit_site') == "vimeo"): // If Vimeo Selected ?>
            <div class="responsive-embed vimeo widescreen">
                <iframe width="640" height="360" src="//player.vimeo.com/video/<?php the_sub_field('unit_vimeo_link_id'); ?>" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
            </div>
        <?php endif; ?>

        <?php if(get_sub_field('unit_site') == "youtube"): // If YouTube Selected ?>
            <div class="responsive-embed youtube widescreen">
                <iframe src="//www.youtube.com/embed/<?php the_sub_field('unit_youtube_link_id'); ?>" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
            </div>
        <?php endif; ?>
    <?php endif; ?>
